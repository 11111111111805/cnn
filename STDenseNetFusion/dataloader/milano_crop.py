...
from STDenseNetFusion.models.MinMaxNorm import MinMaxNorm01
from STDenseNetFusion.dataloader.STMatrix import STMatrix
...
def load_data(path, traffic_type, closeness_size, period_size, trend_size, len_test, nb_flow,
    ...
    index = to_datetime(index, format='%Y-%m-%d %H:%M:%S')  # ✅ 加上秒数
